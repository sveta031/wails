...
assets used in packaging (icon, info.plist, manifest file, etc) are part of your project and 
Use Control + Shift + m to switch the tab of the focus movement key.
